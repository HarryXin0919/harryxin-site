...
const RESEARCH_STATES = new Set(["queued", "running", "idle", "complete", "blocked"]);
...
const RESEARCH_COHORTS = new Set(["pilot", "confirmation", "exploratory"]);
const RESEARCH_PROTOCOL_MODES = new Set(["post_outcome_exploratory"]);
